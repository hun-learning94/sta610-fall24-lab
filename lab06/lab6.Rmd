...
$$
with $\epsilon_{i, j} \stackrel{iid}{\sim} N(0, \Sigma)$ and $\alpha_j \stackrel{iid}{\sim} N(0, \Psi)$ ($\epsilon \perp \alpha$).

Find the following conditional expectations and variances/covariances:
\begin{itemize}
\item
$E[y_{i, j} | x, z, \beta, \Phi, \Sigma]$ and $Cov(y_{i, j}, y_{i', j'} | x, z, \beta, \Phi, \Sigma)$;
\item
$E[\beta | z, x, y, \alpha, \Sigma]$ and $V[\beta | z, x, y, \alpha, \Sigma]$;
\item
$E[\beta | z, x, y, \Phi, \Sigma]$ and $V[\beta | z, x, y, \Phi, \Sigma]$;
\item
$E[\alpha_j | z, x, y, \beta, \Phi, \Sigma]$ and $V[\alpha_j | z, x, y, \beta, \Phi, \Sigma]$.
\end{itemize}
